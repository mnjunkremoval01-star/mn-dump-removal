...
export function Footer() {
  ...
  return (
    <footer className="mt-24 bg-brand-black text-brand-cream">
      ...
      <div className="border-t border-white/10 py-6">
        <Container className="flex flex-col gap-2 text-xs text-brand-cream/60 sm:flex-row sm:items-center sm:justify-between">
