...
export function CallButton({ className = "" }: { className?: string }) {
  ...
  return (
    <a
      ...
      className={`inline-flex items-center justify-center gap-2 rounded-md bg-brand-orange px-6 py-3 text-base font-semibold tracking-wide text-white transition-colors duration-150 hover:bg-brand-orange-dark focus-visible:outline focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-brand-orange ${className}`}
    >
